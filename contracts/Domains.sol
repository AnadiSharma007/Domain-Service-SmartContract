...
contract Domains is ERC721URIStorage {
    ...
    //Mapping data type to store user names
    ...
    constructor(string memory _tld) payable ERC721("HelloThere Name Service", "HTNS"){
    ...
    // A register function that add there name to the mapping
    function register(string calldata name) public payable{
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the HelloThere name service", "image": "data:image/svg+xml;base64,',
